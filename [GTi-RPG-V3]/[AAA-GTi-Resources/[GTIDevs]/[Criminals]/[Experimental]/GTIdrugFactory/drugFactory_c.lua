...
function bind_key ( player )
    if ( player == localPlayer and exports.GTIemployment:getPlayerJob ( true ) == "Criminal" and not isPedInVehicle ( localPlayer ) and isPedOnGround ( localPlayer ) ) then
