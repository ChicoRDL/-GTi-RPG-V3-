...
function startShaderResource()
 ...
 skydome_shader = dxCreateShader ( "Shaders/dynamic_sky/shaders/shader_skydome.fx",0,0,true,"object" )
 null_shader = dxCreateShader ( "Shaders/dynamic_sky/shaders/shader_null.fx" )
 skydome_texture=dxCreateTexture("Shaders/dynamic_sky/textures/skydome.jpg")
 ...
 txd_skybox = engineLoadTXD('Shaders/dynamic_sky/models/skybox_model.txd')
 engineImportTXD(txd_skybox, modelID)
 dff_skybox = engineLoadDFF('Shaders/dynamic_sky/models/skybox_model.dff', modelID)
