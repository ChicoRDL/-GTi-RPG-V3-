...
function startCarPaintReflect()
		...
		setEffectV()
		-- Create stuff
		grunShader = dxCreateShader ( "Shaders/car_reflection/fx/car_refgrun.fx",1,v.renderDistance,false)
		geneShader = dxCreateShader ( "Shaders/car_reflection/fx/car_refgene.fx",1,v.renderDistance,false)
		shatShader = dxCreateShader ( "Shaders/car_reflection/fx/car_refshat.fx",1,v.renderDistance,true)
		...
		if grunShader and geneShader and shatShader and myScreenSource then
			...
			-- Set texture
			textureVol = dxCreateTexture ( "Shaders/car_reflection/images/smallnoise3d.dds" )
