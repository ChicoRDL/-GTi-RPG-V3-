...
function startWaterShine()
		...
		-- Create shader
		myWaterShader, tec = dxCreateShader ( "Shaders/water_shine/fx/water.fx",0,0,false )
		...
		if not myWaterShader then
			...
			-- Set textures
			textureVol = dxCreateTexture ( "Shaders/water_shine/images/wavemap.png" );
			textureCube = dxCreateTexture ( "Shaders/water_shine/images/cube_env256.dds" );
