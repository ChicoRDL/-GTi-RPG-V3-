...
function enableDetail()
	...
	-- Load textures
	detail22Texture = dxCreateTexture('Shaders/detailed/media/detail22.png', "dxt3")
	detail58Texture = dxCreateTexture('Shaders/detailed/media/detail58.png', "dxt3")
	detail68Texture = dxCreateTexture('Shaders/detailed/media/detail68.png', "dxt1")
	detail63Texture = dxCreateTexture('Shaders/detailed/media/detail63.png', "dxt3")
	dirtyTexture = dxCreateTexture('Shaders/detailed/media/dirty.png', "dxt3")
	detail04Texture = dxCreateTexture('Shaders/detailed/media/detail04.png', "dxt3")
	detail29Texture = dxCreateTexture('Shaders/detailed/media/detail29.png', "dxt3")
	detail55Texture = dxCreateTexture('Shaders/detailed/media/detail55.png', "dxt3")
	detail35TTexture = dxCreateTexture('Shaders/detailed/media/detail35T.png', "dxt3")
...
function getMakeShader(v)
	...
	local shader,tec = dxCreateShader ( "Shaders/detailed/fx/detail.fx", 1, 100 )
	if shader then
