...
function setCustomBlipColor(blip, r, g, b)
	blip = convertToWidget ( blip )
	r, g, b = tonumber(r), tonumber(g), tonumber(b)
	if not isWidget(blip) or not streamedBlips[blip] or not r or not g or not b then
		outputDebugString("setCustomBlipColor - Bad argument",0)
		return false	
	end
