...
function set_Weather ( )
	if weather == false then
		setWeather ( 12 )
		weather = true
	elseif weather == true then
		setWeather ( 1 )
		weather = false
	end
end
addCommandHandler ("clouds", set_Weather )
...
txd2 = engineLoadTXD("Walls.txd")
  engineImportTXD(txd2, 13370)
  engineImportTXD(txd2, 13371)

txd3 = engineLoadTXD("Entrance.txd")
  engineImportTXD(txd3, 13157)

txd4 = engineLoadTXD("House.txd")
  engineImportTXD(txd4, 18267)
  engineImportTXD(txd4, 18259)

txd5 = engineLoadTXD("Rocks.txd")
  engineImportTXD(txd5, 18225)

txd6 = engineLoadTXD("Trees.txd")
  engineImportTXD(txd6, 689)

txd7 = engineLoadTXD("Walls2.txd")
  engineImportTXD(txd7, 18300)

txd8 = engineLoadTXD("Plants.txd")
  engineImportTXD(txd8, 825)

txd9 = engineLoadTXD("Plants2.txd")
  engineImportTXD(txd9, 820)

--[[txd10 = engineLoadTXD("swat.txd")
  engineImportTXD(txd10, 285)]]

--[[txd11 = engineLoadTXD("spy.txd")
