...
function raceMarkerHit(hitElement, sameDim)
	if (hitElement == localPlayer and sameDim) then
		if (currentMarkerIndex < #positions) then
			...
			triggerServerEvent("GTIevents.SetRaceWinner", root)
		end
...
addEvent("GTIevents.CreateRaceStuff", true)
addEventHandler("GTIevents.CreateRaceStuff", root, addRaceStuff)
...
addEvent("GTIevents.DestroyRaceStuff", true)
addEventHandler("GTIevents.DestroyRaceStuff", root, destroyRaceStuff)
...
addEvent("GTIevents.UpdateMarkers", true)
addEventHandler("GTIevents.UpdateMarkers", root, updateMarkers)
...
addEvent("GTIevents.AddCheck", true)
addEventHandler("GTIevents.AddCheck", root, addCheck)
...
addEvent("GTIevents.DelPrevCheck", true)
addEventHandler("GTIevents.DelPrevCheck", root, delCheck)
--test
