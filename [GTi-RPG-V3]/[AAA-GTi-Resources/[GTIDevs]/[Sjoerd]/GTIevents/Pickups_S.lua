...
function onMarkerHit(hitElement, mDim)
    if (hitElement and getElementType(hitElement) == "player" and mDim and getElementInterior(hitElement) == getElementInterior(source)) then
        ...
        if (pType == "hp") then
            ...
            exports.GTIhud:dm("You have been given "..t[3].." health", hitElement, 0, 255, 255)
        elseif (pType == "armor") then
            setPedArmor(hitElement, t[3])
            exports.GTIhud:dm("Your armor has been set to "..tonumber(t[3]), hitElement, 0, 255, 255)
        ...
        elseif (pType == "pct") then
            if (getPedWeapon(hitElement, 11) ~= 46) then
                ...
                exports.GTIhud:dm("You have been given a parachute", hitElement, 0, 255, 255)
            end
        end
    end
end
...
addEvent("GTIevents.DeletePickup", true)
addEventHandler("GTIevents.DeletePickup",root, deletePickupViaRB)
