...
function toggleDriveby()
	...
	-- Disable Drive-by when the vehicle is less than 30%
	if (getElementHealth(getPedOccupiedVehicle(localPlayer)) <= 300) then return end
...
function onWeaponSwitchWhileDriveby (prevSlot, curSlot)
