...
function startSmoking ( thePlayer )
    ...
    if cigarettes[thePlayer] == nil and not isTimer(cooldowns[thePlayer]) then
    	...
    	-- Info message
    	exports.GTIhud:dm( "Smoking: Right click to smoke, walk forward to stop smoke (W).", thePlayer, 125, 125, 0 )
    	setTimer( showDelayInfo, 2000, 1, "Smoking: Use /stopsmoke or walk sideways (A or D) to throw your cigarette away", thePlayer, 125, 125, 0)
    	...
    	-- Increase stats by 1
		local playeraccount = exports.GTIaccounts:SAD( thePlayer )
		local cigarrs = exports.GTIaccounts:SAD( playeraccount, "acorp_stats_cigarrs_smoked" ) or 0
		exports.GTIaccounts:SAD( playeraccount, "acorp_stats_cigarrs_smoked", cigarrs + 1 )
...
function showDelayInfo(msgText, thePlayer, r, g, b)
	exports.GTIhud:dm(msgText, thePlayer, r, g, b)
end
