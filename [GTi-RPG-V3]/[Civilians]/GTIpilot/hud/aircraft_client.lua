...
attitudeIndicator = dxCreateTexture("files/attitude_indicator.png" , "argb", true,"clamp" )
altimeter1 = dxCreateTexture("files/altimeter_1.png" , "argb", true,"clamp" )
variometer = dxCreateTexture("files/variometer.png" , "argb", true,"clamp" )
altimeterPointer1 = dxCreateTexture("files/altimeter_pointer_1.png" , "argb", true,"clamp" )
altimeterPointer2 = dxCreateTexture("files/altimeter_pointer_2.png" , "argb", true,"clamp" )
airspeedIndicator = dxCreateTexture("files/airspeed_indicator.png" , "argb", true,"clamp" )
compass1 = dxCreateTexture("files/compass_1.png" , "argb", true,"clamp" )
compass2 = dxCreateTexture("files/compass_2.png" , "argb", true,"clamp" )
corner1 = dxCreateTexture("files/corner_1.png" , "argb", true,"clamp" )
corner2 = dxCreateTexture("files/corner_2.png" , "argb", true,"clamp" )
ledon = dxCreateTexture("files/led_on.png" , "argb", true,"clamp" )
ledoff = dxCreateTexture("files/led_off.png" , "argb", true,"clamp" )

function renderAircraftFX()
    if (isPlayerMapVisible()) then return end
    if (not exports.GTIsettingsApp:getSettingEnabled("Pilot HUD")) then 
	removeEventHandler ("onClientRender", root, renderAircraftFX) 
	return 
    end
