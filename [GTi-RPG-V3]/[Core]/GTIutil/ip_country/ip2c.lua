...
function getIpCountry ( ip )
	if type(ip) ~= "string" then return "N/A" end
	--outputDebugString(type(ip))
...
-- Load all IP groups from "conf/ip_country/IpToCountryCompact.csv"
function loadIPGroupsWorker ()
	unrelPosReset()

	local readFilename = "ip_country/IpToCountryCompact.csv";
...
----------------------------------------------------------------------------------------
--
-- How to update admin\conf\ip_country/IpToCountryCompact.csv:
--
...
-- 7. Brand new'ip_country/IpToCountryCompact.csv' should now be in admin\conf\ and will be used when admin is restarted
--
----------------------------------------------------------------------------------------
...
if makeAndTestCompactCsv then
	...
	function makeCompactCsvWorker ()
		...
		local writeFilename = "conf/ip_country/IpToCountryCompact.csv";
